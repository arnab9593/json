...
let arrFromRejectLS = JSON.parse(localStorage.getItem("admission-rejected"))

displayTable(arrFromRejectLS);

function displayTable(arrFromRejectLS){
    arrFromRejectLS.forEach(function (elem){
