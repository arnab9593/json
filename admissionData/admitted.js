...
let arrFromAcceptLS = JSON.parse(localStorage.getItem("admission-accepted"))

displayTable(arrFromAcceptLS);

function displayTable(arrFromAcceptLS){
    arrFromAcceptLS.forEach(function (elem){
